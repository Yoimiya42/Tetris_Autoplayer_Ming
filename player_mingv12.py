...
class MingPlayer(Player):
    ...
    weighted_height= -100
    weighted_holes = -400 # - 0.954915
    weighted_bumpiness = -5
    # weighted_lines_cleared = 1.5 #0.760066
    
    weighted_three_lines_cleared = 0
    weighted_one_line_cleared = -150
    weighted_two_lines_cleared = -50
...
#_______________________________________________________________________________#
    ...
    def calculate_lines_cleared(self, board):
        ...
        if diff_score >= 1600:
            ...
            return self.weighted_three_lines_cleared
        
        elif diff_score >= 100:
            self.lines_cleared = 2
            return self.weighted_two_lines_cleared
...
######################################### Evaluation Function #############################################
    def evaluation(self, board):
        ...
        if self._get_max_height(board) > 17:
            self.weighted_three_consecutive_lines = 1600
            # self.weighted_one_line_cleared = 0
        else:
            self.weighted_three_consecutive_lines = 0
            # self.weighted_one_line_cleared = -400
