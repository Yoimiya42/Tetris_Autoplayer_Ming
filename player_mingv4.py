...
# Action Functions
    ...
    def translation(self, board, dest_x):
        ...
        if board.falling is not None:
            ...
            while start_x > dest_x and has_landed is False:
...
# Core Function
    ...
    def choose_action(self, board):
        ...
        if discord_counter > 7 and board.discards_remaining > 0:
            discord_counter -= 1
        ...
        for trans1 in range(start_column,board.width):
            for rot1 in range(4):
                ...
                if demo1_board.falling is not None:
                    ...
                    # actions_list1.extend(self.translation(demo1_board, start_x, trans1))
                    ...
                    for trans2 in range(board.width):
                        for rot2 in range(4):
                            ...
                            if demo2_board.falling is not None:
                                ...
                                # actions_list2.extend(self.translation(demo2_board, start_x, trans2))
                            ...
                            if final_score > best_score:
                                ...
                                best_holes = self.calculate_total_holes(best_board)
        
        if (best_holes - self.previous_holes > 1) and board.discards_remaining > 0  and self.counter_block < 200:
            return [Action.Discard]
        
        if board.bombs_remaining > 0 and self._get_max_height(best_board) > 16:
            return [Action.Bomb]
